...
| 阶段   | 名称                 | 适用项目  | 关键输出                            |
| ------ | -------------------- | --------- | ----------------------------------- |
| 阶段-1 | 技术栈调研与选型     | 新项目    | tech-selection-report.md, AGENTS.md |
| 阶段0  | 项目初始化与底座搭建 | 新/老项目 | docs体系, 依赖矩阵, AGENTS.md       |
| 阶段1  | 需求全链路标准化     | 所有项目  | prd.md, srs.md                      |
| 阶段2  | 系统架构与分端设计   | 所有项目  | 架构设计, 页面/接口设计             |
| 阶段3  | 分端模块化开发       | 所有项目  | 源代码, 实施计划                    |
| 阶段4  | 自动化集成测试与交付 | 所有项目  | 测试报告                            |
| 阶段5  | 需求变更闭环管控     | 所有项目  | 变更报告                            |
...
3. **新项目：阶段-1完成后自动搜索技术栈 skills** → 使用 `/find-skills` 指令
4. 按需引入相关模板文档执行
